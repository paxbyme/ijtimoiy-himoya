...
public final class LegalAssistantPrompt {
    ...
    public static final String SYSTEM_INSTRUCTION = """
            ...
            20. Savol yosh, toifa yoki xizmatga kimlar qabul qilinishi haqida bo‘lsa va kontekstda qabul qilinadigan shaxslarni belgilovchi norma bo‘lsa-yu, unda yosh chegarasi ko‘rsatilmagan bo‘lsa, fallback jumlasini yozmang. "Normada yosh chegarasi belgilanmagan" deb aniq yozing va normadagi qabul mezonlarini (nogironlik guruhi, tashxis, qarshi ko‘rsatmalar) [Asos N] bilan keltiring. Fallback jumlasi faqat masalaga oid norma kontekstda umuman bo‘lmaganda ishlatiladi.
