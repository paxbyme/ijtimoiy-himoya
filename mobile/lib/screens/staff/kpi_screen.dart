...
class KpiScreen extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    return Scaffold(
      appBar: AppBar(title: const Text('Mening KPI')),
      body: AppBackground(
        child: kpiAsync.when(
          ...
          error: (error, _) => Center(
            child: Column(
              ...
              children: [
                ...
                Text(
                  'KPI ma\'lumotlarini yuklab bo\'lmadi',
              ...
              return Center(
                child: Column(
                  ...
                  children: [
                    ...
                    const SizedBox(height: 16),
                    Text(
                      'Hali KPI ma\'lumotlari yo\'q',
                      style: theme.textTheme.bodyLarge,
                    ),
                    const SizedBox(height: 8),
                    Text(
                      'Samaradorlik ballingizni ko\'rish uchun topshiriqlarni bajaring.',
                      ...
                      if (kpi.rank != null) ...[
                        Card(
                          child: ListTile(
                            ...
                            subtitle: Text(
                              'Siz bo\'limingizda #${kpi.rank} o\'rindasiz',
                            ),
                          ),
                        ),
                        const SizedBox(height: 16),
